...
public class MetasOptions implements Serializable {
    ...
    private void optionsInitiate(){
        ...
        Option tmpDirOpt = new Option(null, "driver-tmp-dir", true,
                "Local temp directory on driver. The directory is used for storing files generated by non-spark codes.   Default is spark.local.dir or hadoop.tmp.dir, or /tmp/ if none is set. " +
    ...
    private void optionsParse(String[] args){
        ...
        try {
            ...
            if (commandLine.hasOption("driver-tmp-dir")) {
                this.driverTmpDir = commandLine.getOptionValue("driver-tmp-dir", "/tmp/SOAPMetaS_Driver_temp");
                //this.alignmentTmpDir = this.driverTmpDir + "/alignment/";
                //this.profilingTmpDir = this.driverTmpDir + "/profiling/";
            }
