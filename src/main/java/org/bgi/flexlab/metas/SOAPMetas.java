...
public class SOAPMetas {
    ...
    public static void main(String[] args){
        ...
        List<String> profilingOutputList = null;
        ...
        //System.out.println("[SOAPMetas::" + SOAPMetas.class.getName() + "] Total time: " + Double.toString((double) (PROFILING_TIME + PROFILINGJSC_TIME + ALIGNMENT_TIME + ALIGNMENTJSC_TIME)/1000) + "s");
    }
}
