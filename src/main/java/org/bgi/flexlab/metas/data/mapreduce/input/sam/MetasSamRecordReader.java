 ...
 * Description: The class is based on org.seqdoop.hadoop_bam.SAMRecordReader. The main body is
 *  copied from original script. Here we did some modification for particular usage.
 *
 * @author heshixu@genomics.cn
 */

public class MetasSamRecordReader extends RecordReader<Text, MetasSamRecordWritable> {
    ...
    @Override public MetasSamRecordWritable getCurrentValue() { return record; }
