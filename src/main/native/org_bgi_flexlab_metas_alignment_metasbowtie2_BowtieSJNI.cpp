...
JNIEXPORT jint JNICALL Java_org_bgi_flexlab_metas_alignment_metasbowtie2_BowtieSJNI_bowtie_1jni (JNIEnv *env, jobject obj, jint argc, jobjectArray argStrArray, jstring logFile){
